...
export async function generateMetadata({ params }: RatgeberPageProps): Promise<Metadata> {
  ...
  const url = `https://welpenschule-neusiedl.at/ratgeber/${post.slug}`;
  return {
    ...
    openGraph: {
      ...
      images: [{ url: `https://welpenschule-neusiedl.at${post.heroImage}`, width: 1600, height: 900, alt: post.heroAlt }],
    },
  };
}
