      ...
      <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="relative z-20 text-center px-6 md:px-12 py-16 bg-white/10 backdrop-blur-md rounded-3xl shadow-2xl border border-white/20 max-w-5xl mx-auto transform translate-y-8">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-white tracking-tight drop-shadow-xl mb-6">
            Welpenschule Neusiedl <br className="hidden md:block" />am See mit <span className="text-yellow-400 bg-clip-text">Willenskraft</span>
          </h1>
          <p className="text-lg md:text-2xl text-gray-100 max-w-3xl mx-auto font-medium leading-relaxed drop-shadow-md">
            Dein ganzheitlicher und gewaltfreier Weg zum Dream-Team. Für Welpen bis 5 Monate in & um Neusiedl am See.
          </p>
      ...
      <section id="konzept" className="container mx-auto px-6 py-24 sm:py-32">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-lg sm:text-xl text-gray-600 leading-relaxed max-w-3xl mx-auto">
            Du hast sicher viele Fragen zur Erziehung, Sozialisierung und Körpersprache. Du möchtest deinen Welpen optimal auf seinen zukünftigen Alltag vorbereiten und die richtigen Spielgefährten finden? Dann bist du in unserer Welpenschule genau richtig! Gemeinsam bauen wir eine harmonische, stressfreie Beziehung auf.
          </p>
        </div>
      </section>
      ...
      <section className="bg-slate-50/50 py-24 sm:py-32">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600">Die wichtigsten Antworten rund um den Start in der Welpenschule Neusiedl am See.</p>
          </div>
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          ...
          <div className="bg-gradient-to-r from-slate-900 to-slate-800 p-10 rounded-3xl text-center mb-16 shadow-2xl relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-400 mt-6 font-medium">In jedem Monat startet mindestens ein neuer Kurs in Neusiedl am See.</p>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 max-w-5xl">
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-8 sm:p-16 rounded-[40px] shadow-2xl flex flex-col md:flex-row items-center gap-12 sm:gap-16 border border-slate-700">
            ...
            <div className="w-full md:w-7/12 text-center md:text-left relative z-10">
              ...
              <p className="text-xl text-slate-300 mb-10 leading-relaxed font-medium">Melde dich und deinen Welpen jetzt für ein erstes Kennenlernen in der <span className="text-yellow-400 font-bold drop-shadow-sm">Welpenschule Neusiedl am See</span> an.</p>
