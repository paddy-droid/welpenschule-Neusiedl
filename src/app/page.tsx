...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    {
      '@type': 'Question',
      name: 'Was kostet die Welpenschule am Neusiedlersee?',
      acceptedAnswer: {
        '@type': 'Answer',
    ...
    {
      '@type': 'Question',
      name: 'Ist das Training auch für Wildvogel-affine Hunde geeignet?',
      acceptedAnswer: {
        '@type': 'Answer',
...
const howToJsonLd = {
  '@context': 'https://schema.org',
  '@type': 'HowTo',
  name: 'Welpentraining in 6 Wochen — Was dein Welpe in der Welpenschule Neusiedl am See lernt',
  description:
    'Strukturierter 6-Wochen-Plan unseres Welpenkurses am Neusiedlersee: Sozialisierung, Grundsignale, Leinenführigkeit, Medical Training und mehr.',
  totalTime: 'P6W',
  ...
  step: [
    ...
    { '@type': 'HowToStep', position: 4, name: 'Woche 4 – Umweltreize & Impulskontrolle', text: 'Training mit Ablenkung, Frust-Toleranz aufbauen, Bleib-Signal, Begegnungen mit Joggern, Radfahrern und Wasservögeln.' },
    ...
    { '@type': 'HowToStep', position: 6, name: 'Woche 6 – Festigen & Transfer', text: 'Alle Signale unter realen Alltagsbedingungen — von der Promenade bis zum Schilfgürtel — individuelle Themen, Plan für die nächsten 6 Monate.' },
  ],
};
...
const roadmap = [
  ...
  { week: 4, title: 'Umwelt & Impulskontrolle', bullets: ['Reize: Vögel, Radfahrer, Kinder', 'Bleib mit kurzer Dauer', 'Frust-Toleranz aufbauen'] },
  { week: 5, title: 'Medical Training & Alltag', bullets: ['Pfoten, Maul, Ohren', 'Bürsten & Berührung', 'Geräusche-Habituation'] },
  { week: 6, title: 'Festigen & Transfer', bullets: ['Alle Signale am Seeufer', 'Individueller Folgeplan', 'Junghund-Ausblick'] },
];
    ...
    <div className="bg-background">
      ...
      <section id="konzept" className="wk-section">
        <div className="container mx-auto px-6 max-w-4xl text-center">
          <span className="wk-eyebrow mb-6">Willkommen am See</span>
          <h2 className="wk-display text-4xl md:text-5xl lg:text-6xl text-ink-950">
          ...
          <p className="mt-8 text-lg md:text-xl text-ink-600 leading-relaxed max-w-3xl mx-auto">
            Die ersten Wochen prägen deinen Hund auf Lebenszeit. In unserer Welpenschule am Neusiedlersee lernst du,
            die Körpersprache deines Vierbeiners zu lesen, ihm Sicherheit zu geben und seine Sozialisierung gezielt
            zu lenken. Kein Druck. Keine Dominanztheorie. Nur Verbindung — vor pannonischer Kulisse.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <div className="lg:col-span-7 space-y-12">
              ...
              <div className="space-y-4">
                <span className="wk-eyebrow-lake">Sozialisierung</span>
                <h3 className="wk-display text-3xl md:text-5xl text-ink-950">
                  Mit Plan. Am See.
                </h3>
                <p className="text-lg text-ink-600 leading-relaxed">
                  ...
                  oft jahrelang nach. Die pannonische Ruhe rund um Neusiedl ist dabei unser bester Verbündeter.
                </p>
              </div>
      ...
      <section className="wk-section">
        <div className="container mx-auto px-6 max-w-7xl">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            {/* Sonderangebot — gold + lake gradient (signature) */}
            <div className="sm:col-span-2 lg:col-span-1 relative overflow-hidden rounded-3xl p-8 bg-gradient-to-br from-brand-400 via-brand-500 to-lake-700 text-ink-950 shadow-[0_30px_60px_-20px_rgba(186,135,30,0.5)]">
              <div className="absolute -top-12 -right-12 w-40 h-40 rounded-full bg-cream/30 blur-3xl" />
              <div className="absolute -bottom-12 -left-12 w-40 h-40 rounded-full bg-lake-300/40 blur-3xl" />
        ...
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="mt-6 text-lg text-ink-600 leading-relaxed">
              ...
              roter Faden — vom ersten Markersignal bis zum souveränen Auftritt am Seeufer.
            </p>
          </div>
      ...
      <section className="wk-section">
        <div className="container mx-auto px-6 max-w-4xl">
          <div className="text-center mb-16">
            ...
            <p className="mt-6 text-lg text-ink-600">
              Die wichtigsten Antworten rund um den Start in der Welpenschule Neusiedl am See.
            </p>
          </div>
