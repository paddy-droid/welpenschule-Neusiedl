...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      description:
        'Jessica Pusch — von ihren Kund:innen Jessy genannt — ist Hundetrainerin der Hundeschule Willenskraft und betreut als mobile Hundetrainerin den gesamten Bezirk Neusiedl am See. Sie trainiert ausschließlich gewaltfrei mit positiver Verstärkung und kommt zum Training direkt zu den Mensch-Hund-Teams nach Hause.',
      ...
      knowsAbout: ['Welpentraining', 'Positive Verstärkung', 'Medical Training', 'Verhaltensberatung', 'Mobiles Hundetraining'],
    },
    {
      '@type': 'WebSite',
