...
export const regionData: Record<string, RegionData> = {
  'neusiedl-am-see': {
    ...
    faqs: [
      { question: 'Wo findet das Training in Neusiedl am See statt?', answer: 'Wir trainieren bei dir zuhause in Neusiedl, an der Seepromenade, im Schilfgürtel oder rund um die Stadtweinberge. Die Trainings­orte richten sich nach deinen Zielen und dem Charakter deines Hundes — im Strandbad selbst gilt übrigens Hundeverbot, die Promenade davor ist aber perfektes Trainingsgelände.' },
      ...
      { question: 'Trainiert ihr auch beim Strandbad?', answer: 'Im Strandbad selbst gilt Hundeverbot — und genau das nutzen wir: Die belebte Promenade davor ist im Sommer ideal für Begegnungs­training mit fortgeschrittenen Hunden. Außerhalb der Saison üben wir dort in Ruhe Leinenführigkeit und Rückruf.' },
  ...
  'weiden-am-see': {
    ...
    faqs: [
      ...
      { question: 'Trainiert ihr auch beim Strandbad?', answer: 'Im Strandbad selbst gilt Hundeverbot. Dafür ist das Umfeld in der Saison (Mai–September) sehr belebt — perfekt für fortgeschrittene Hunde-Begegnungen am Seeufer und beim Hafen. Außerhalb der Saison nutzen wir die ruhigen Uferbereiche für entspannte 1:1-Sessions am Wasser.' },
    ...
    regionSectionIntro: 'Weiden am See ist eine Sonderstellung im Bezirk: Direkt am Wasser gelegen, mit dem größten Strandbad der Region und einer einzigartigen Mischung aus Tourismus, Weinbau und Wohngebiet. Für dein Hundetraining bedeutet das Vielfalt pur: Eine Trainings­einheit kann am stillen Schilfgürtel beginnen, am belebten Seeufer beim Hafen fortgesetzt und in den ruhigen Weinbergen abgeschlossen werden — alles innerhalb von 10 Minuten Fahrzeit. Perfekt für Hunde, die in der modernen Welt souverän sein wollen.',
    regionHighlights: [
      { title: 'Seeufer &amp; Hafen', description: 'Größter Seezugang der Region — perfekt für Wasser­training, Begegnungen und Souveränitäts­aufbau in der Saison (im Strandbad selbst gilt Hundeverbot).', icon: 'lake' },
    ...
    regionTableRows: [
      { trainingsort: 'Seeufer &amp; Hafen Weiden', entfernung: '0–5 Min.', besonderheit: 'Größter Seezugang der Region — Strandbad selbst: Hundeverbot', trainingsart: 'Wasser­training, Begegnungen' },
  ...
  'podersdorf-am-see': {
    ...
    faqs: [
      ...
      { question: 'Mein Hund zieht zum Wasser — was tun?', answer: 'Der offene Seezugang ist verlockend. Wir bauen ein klares Erlaubnis-Signal auf, sodass dein Hund nur ins Wasser geht, wenn du es freigibst — wichtig wegen Booten, Surfern und Algen im Hochsommer. Das Beste: Podersdorf hat einen ausgewiesenen Hundebadeplatz am Nordstrand — dort üben wir das ganz offiziell, mit positiver Verstärkung.' },
    ...
    localFeatures: [
      'Ausgewiesener Hundestrand am Nordstrand — Baden offiziell erlaubt',
    ...
    regionTableRows: [
      ...
      { trainingsort: 'Hundestrand (Nordstrand)', entfernung: '3 Min.', besonderheit: 'Ausgewiesener Hundebadeplatz — Baden offiziell erlaubt', trainingsart: 'Wassertraining, Erlaubnis-Signal' },
