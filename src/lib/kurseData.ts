/**
 * Gruppenkurs-Angebot von Jessy (Willenskraft-Standort Bruck/Leitha–Wien–Nordburgenland)
 * für die Region Neusiedl am See. Quelle: willenskraft.co.at Kurs-Detailseiten
 * (Preise, Einheiten, Inhalte, Voraussetzungen — Stand 2026-06).
 */
...
export const kurse: KursData[] = [
  {
    ...
    claim: 'Der gewaltfreie & ganzheitliche Start ins Hundeleben — 6 Einheiten in Kleingruppen an Outdoor-Treffpunkten in deiner Region.',
    price: '195 €',
    ...
    heroAlt: 'Welpengruppe lernt auf der Wiese — Welpenkurs der mobilen Hundeschule Willenskraft Region Neusiedl am See',
    ...
    wkImage2: { src: `${WK}/2024/05/Hundeschule-Willenskraft-Parndorf-Welpenschule-845x684.webp`, alt: 'Welpenschule mit Willenskraft in Parndorf — Training in der Region Neusiedl am See' },
    ...
    metaTitle: 'Welpenkurs Neusiedl am See – 6 Einheiten | Willenskraft',
    metaDescription: 'Welpenkurs mit Jessy: 6 Einheiten à 60 Min. um 195 € ✓ max. 4 Teams ✓ gewaltfrei ✓ Treffpunkte in deiner Region. ☎ 0664 3903673',
  },
  {
    slug: 'junghundekurs',
    name: 'Junghundekurs',
    ...
    intro: [
      ...
      'Gerade in der Pubertät scheint vieles „plötzlich weg" zu sein — das ist normal und vor allem trainierbar. Mit Struktur, positiver Verstärkung und echten Alltagssituationen wird aus dem wilden Teenager ein souveräner Begleiter.',
    ],
    inhalte: [
    ...
    faqs: [
      ...
      { question: 'Was kostet der Junghundekurs?', answer: 'Der Kurs umfasst 6 Einheiten zu je einer Stunde und kostet 195 €. Jeden Monat startet mindestens ein neuer Kurs in der Region.' },
    ...
    heroAlt: 'Junghund übt Blickkontakt mit Halterin am Feldweg — Junghundekurs Willenskraft Region Neusiedl am See',
    ...
    wkImage2: { src: `${WK}/2024/05/Hundeschule-Jois-Markertraining-845x684.webp`, alt: 'Markertraining mit Willenskraft in Jois am Neusiedlersee' },
    ...
    metaTitle: 'Junghundekurs Neusiedl am See | Willenskraft',
    metaDescription: 'Junghundekurs mit Jessy: 6 Einheiten um 195 € ✓ Rückruf, Impulskontrolle & Begegnungen ✓ gewaltfrei ✓ Region Neusiedl. ☎ 0664 3903673',
  },
  {
    ...
    intro: [
      ...
      'Das Ziel: sichere, entspannte und freudige Spaziergänge — für dich und deinen Hund. Die praktischen Übungseinheiten mit den anderen Teams simulieren echte Begegnungen, aber in einem Rahmen, in dem dein Hund lernen kann statt nur reagieren zu müssen.',
    ],
    inhalte: [
    ...
    heroAlt: 'Zwei Hunde begegnen sich entspannt an lockerer Leine — Begegnungstraining Willenskraft Region Neusiedl am See',
    ...
    metaTitle: 'Begegnungstraining für Hunde Neusiedl | Willenskraft',
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'Wo wird trainiert?', answer: 'An wechselnden, großzügigen Trainingsarealen in der Region — die weiten Wiesen und Felder rund um den Neusiedlersee sind dafür ideal. Die Treffpunkte erfährst du bei der Anmeldung.' },
    ],
    heroImage: '/heroes/kurs-dummy.webp',
    heroAlt: 'Hund apportiert freudig einen Trainingsdummy über die Wiese — Dummytraining Willenskraft Region Neusiedl am See',
    ...
    metaTitle: 'Dummytraining Neusiedl am See | Willenskraft',
  ...
  },
  {
    ...
    start: 'Training auf geeignetem öffentlichem Gelände — Targets & Pflegeutensilien werden gestellt.',
    intro: [
    ...
    heroAlt: 'Hund legt entspannt das Kinn in die Hand der Trainerin (Chinrest) — Medical Training Willenskraft Region Neusiedl am See',
