  ...
  return (
    <div className="bg-background">
          ...
          <div className="max-w-4xl">
            ...
            <div className="mt-7 flex flex-wrap items-center gap-x-6 gap-y-3">
              ...
              <span className="inline-flex items-center gap-2 text-xs text-cream/80">
                <Euro className="w-4 h-4 text-lake-300" /> {kurs.price} · {kurs.units}
              </span>
              <span className="inline-flex items-center gap-2 text-xs text-cream/80">
                <Users className="w-4 h-4 text-lake-300" /> {kurs.groupSize}
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="container mx-auto px-6 pt-14">
        <div id="direktantwort" className="wk-card max-w-4xl mx-auto p-8 md:p-10 border-l-[5px] !border-l-lake-500 scroll-mt-24">
          ...
          <div className="mt-6 flex flex-wrap items-center gap-x-6 gap-y-3 text-xs text-ink-500">
            <span className="inline-flex items-center gap-1.5"><ShieldCheck className="w-3.5 h-3.5 text-lake-600" /> 100 % gewaltfrei</span>
            <span className="inline-flex items-center gap-1.5"><MapPin className="w-3.5 h-3.5 text-lake-600" /> Treffpunkte in deiner Region</span>
            <span className="inline-flex items-center gap-1.5"><ThumbsUp className="w-3.5 h-3.5 text-lake-600" /> 5,0 ★ auf Google</span>
            <span className="inline-flex items-center gap-1.5"><Car className="w-3.5 h-3.5 text-lake-600" /> Mobile Einzelstunden ergänzbar</span>
          </div>
        </div>
      </section>
      ...
      <section className="wk-section bg-card">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <span className="wk-eyebrow-lake mb-5"><ClipboardList className="w-3 h-3" /> Kursinhalte</span>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl mx-auto">
            {kurs.inhalte.map((inhalt) => (
              <div key={inhalt} className="wk-card p-5 flex items-start gap-3">
                <CheckCircle2 className="w-5 h-5 text-lake-600 shrink-0 mt-0.5" />
        ...
        <section className="wk-section bg-card">
          <div className="container mx-auto px-6 max-w-5xl">
            <div className="text-center mb-10">
              <span className="wk-eyebrow-lake mb-5"><CalendarDays className="w-3 h-3" /> Termine</span>
      ...
      <section className="wk-section bg-card">
        <div className="container mx-auto px-6 max-w-6xl">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <span className="wk-eyebrow-lake mb-5">Weitere Kurse</span>
            ...
            {andere.map((k) => (
              <Link key={k.slug} href={`/kurse/${k.slug}`} className="block group">
                <div className="wk-card p-6 h-full">
                  ...
                  <h3 className="font-semibold text-ink-950 group-hover:text-lake-700 transition-colors">{k.name}</h3>
          ...
          <div className="mt-8 text-center">
            <Link href="/kurse" className="inline-flex items-center gap-2 text-sm font-semibold text-ink-700 hover:text-lake-700 transition-colors">
      ...
      <section className="container mx-auto px-6 pb-16 text-center">
        <span className="inline-flex items-center gap-2 text-xs text-ink-500">
          <HomeIcon className="w-3.5 h-3.5 text-lake-600" />
