...
const BASE = 'https://welpenschule-neusiedl.at';

const AUTHORS = {
  jessy: {
    name: 'Ing. Jessica Pusch',
    role: 'Hundetrainerin · Willenskraft Neusiedl am See',
    bio: 'Jessy ist deine mobile Hundetrainerin für den Bezirk Neusiedl am See. Als ausgebildete Biochemikerin (Ing.) und Willenskraft-zertifizierte Trainerin verbindet sie wissenschaftlich fundiertes, gewaltfreies Training nach dem LIFE-Modell mit viel Praxis — und kommt zum Training direkt zu dir nach Hause.',
...
function Block({ block, i }: { block: ContentBlock; i: number }) {
  ...
  switch (block.type) {
    ...
    case 'quote':
      return (
        <figure className="my-8 rounded-3xl bg-gradient-to-br from-brand-50 to-lake-50 border border-brand-200/60 p-7 sm:p-8">
  ...
  return (
    <article className="bg-background">
      ...
      <CtaBanner
        ...
        text="Jessy kommt zu dir nach Hause — in alle 17 Orte des Bezirks. Erstberatung 95 €, Einzelstunde ab 55 €, Anfahrt kostenlos. Oder starte im nächsten Welpenkurs (195 €)."
      />
