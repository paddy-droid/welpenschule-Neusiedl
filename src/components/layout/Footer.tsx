...
export default function Footer() {
  return (
    <footer className="relative mt-12 bg-ink-950 text-ink-200 overflow-hidden">
      ...
      <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-lake-500/60 via-50% to-transparent" />
      ...
      <div className="relative container mx-auto px-6 lg:px-8 pt-20 pb-10">
        <div className="grid lg:grid-cols-12 gap-12 mb-16">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-lake-500/10 border border-lake-500/30 text-lake-300 text-[10px] font-bold uppercase tracking-[0.18em]">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="ml-2 inline-flex items-center gap-1.5 px-3.5 h-10 rounded-full border border-ink-700 hover:border-lake-500 hover:bg-lake-500/10 hover:text-lake-300 text-xs font-medium transition-all"
              >
                willenskraft.co.at
          ...
          <div className="lg:col-span-3">
            <p className="text-[10px] font-bold uppercase tracking-[0.18em] text-lake-400 mb-5">Regionen</p>
            <ul className="grid grid-cols-2 gap-x-3 gap-y-3 text-sm">
              {regionLinks.map((r) => (
                <li key={r.href}>
                  <Link href={r.href} className="hover:text-lake-300 transition-colors">{r.label}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="lg:col-span-2">
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <a href="tel:+436643903673" className="flex items-start gap-2.5 hover:text-lake-300 transition-colors">
              ...
              <li>
                <a
                  ...
                  className="flex items-start gap-2.5 hover:text-lake-300 transition-colors break-all"
                >
