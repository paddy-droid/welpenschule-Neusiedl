    ...
    <footer className="bg-gray-100 mt-12">
      <div className="container mx-auto px-4 py-8 text-gray-600">
        <div className="grid md:grid-cols-3 gap-8 text-center md:text-left mb-8">
            <div>
                ...
                <div className="flex flex-col gap-2">
                    <Link href="/"><p className="hover:text-yellow-500">Startseite</p></Link>
                    <Link href="/kontakt"><p className="hover:text-yellow-500">Kontakt & Anmeldung</p></Link>
                </div>
            </div>
            <div>
                <h3 className="font-bold mb-2">Mobiles Hundetraining</h3>
                <div className="grid grid-cols-2 gap-2">
                    <Link href="/mobiles-hundetraining"><p className="hover:text-yellow-500">Neusiedl am See</p></Link>
                    <Link href="/mobiles-hundetraining/gols"><p className="hover:text-yellow-500">Gols</p></Link>
                    <Link href="/mobiles-hundetraining/frauenkirchen"><p className="hover:text-yellow-500">Frauenkirchen</p></Link>
                    <Link href="/mobiles-hundetraining/parndorf"><p className="hover:text-yellow-500">Parndorf</p></Link>
                    <Link href="/mobiles-hundetraining/weiden-am-see"><p className="hover:text-yellow-500">Weiden am See</p></Link>
                    <Link href="/mobiles-hundetraining/illmitz"><p className="hover:text-yellow-500">Illmitz</p></Link>
                    <Link href="/mobiles-hundetraining/andau"><p className="hover:text-yellow-500">Andau</p></Link>
                </div>
            </div>
            <div>
        ...
        <div className="border-t pt-8">
            ...
            <p className="text-center">&copy; {new Date().getFullYear()} Hundeschule Willenskraft. Alle Rechte vorbehalten.</p>
        </div>
      </div>
    </footer>
  );
